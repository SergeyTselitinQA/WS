...
driver.find_element("xpath", "//*[@id='firstPageBtn']").click()
first_btn = driver.find_element("xpath", "//*[contains(@class,'page-btn') and contains(@class,'bg-blue-600')]").text

assert first_btn == "1", "Не отобразилась последняя страница"
